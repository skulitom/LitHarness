...
### Phase 3 — displays as declared views (first slice done: stage-0 §205, the default sheet retired and a book's own evidence declaring its columns; views, several sheets, the choice display and the notice remain)
