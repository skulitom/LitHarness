...
| Fix the located world/development changes | [Source-boundary probe](world-boundary-fixes-20260913/RUNBOOK.md): fixed Wren plus an opposing synthetic case test acquisition timing, capability access and source motives; scoped world retrieval is measured separately. |
