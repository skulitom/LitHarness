...
LOCAL = ROOT / "runs/causal-reader-admission-20260913"
...
def main() -> None:
    ...
    sources += [
        ROOT / "runs/fresh-chapter-review-20260912/book.db",
        ROOT / "runs/distinctive-continuation-20260913/book-1/serial.db",
    ]
    report = {
        "schema": "litharness.causal-reader-admission.v2",
        "model_calls": 0,
        ...
        try:
            ...
            for book, branch, _head in branches:
                ...
                shape = (
                    ...
                    if any(name in source.parts for name in (
                        "continuation-baseline-20260910", "distinctive-continuation-20260913",
                    ))
                    else ["--chapter-scenes", "4", "--arc-chapters", "6"]
                    if "fresh-chapter-review-20260912" in source.parts
                    else []
                )
                argv = [
                    "--database",
