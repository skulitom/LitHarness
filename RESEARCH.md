...
| Use a source-derived attention trajectory as background versus operative narration guidance | One source-only trace and four matched full chapters registered. Both writer conditions receive identical trace/source; only its role in focus, emphasis and transitions changes. No outputs yet. | `REGISTERED` | [registration](research/quality-measurement/prose-attention/PREREG.md) |
