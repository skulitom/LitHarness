...
<!-- research-overview: ledger through §260; checked 2026-09-23 -->
...
| A registered chapter-one draw on the production default path tests the restored directions end to end: Codex, every role strong, a system-apocalypse brief from the operator's hook templates, rowntree casting, and a coordinator gate at the concept, listing, seeded world and chapter one before any further spend | `REGISTERED` | [research/quality-measurement/restored-directions-draw-20260922/PREREG.md](research/quality-measurement/restored-directions-draw-20260922/PREREG.md) |
