...
| Let one source-derived concern recede and return across several events | One compact concern proposal and four fresh complete chapters registered; source-only comparison versus the added persistent-concern schedule. Source, required ending and common writer system held fixed. No outputs yet; package comparison, not an isolated persistence effect. | `REGISTERED` | [registration](research/quality-measurement/prose-persistent-concern/PREREG.md) |
