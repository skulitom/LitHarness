...
<!-- research-overview: ledger through §259; checked 2026-09-23 -->
...
| The comparison that decides whether the candidate roles move tier: the full-book trial's 24 recorded scene-summary requests replayed on gpt-6-luna at medium and high effort against two fresh gpt-6-astra controls, on the recorded and on today's wording, and the seed rebuilt from the trial's own pre-seed store on gpt-6-sol against gpt-6-astra as a screen; outcomes computed in code only | `REGISTERED` | [research/quality-measurement/model-tiers-20260922/PREREG.md](research/quality-measurement/model-tiers-20260922/PREREG.md) |
