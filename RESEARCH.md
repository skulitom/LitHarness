...
| Separate binding writer facts from required reader-facing narration | Registered: identical 42 source units; all must be conveyed in control, while 11 context/knowledge units may remain implicit in treatment. Four complete chapters; no calls yet. | `REGISTERED` | [registration](research/quality-measurement/prose-narration-obligations/PREREG.md) |
