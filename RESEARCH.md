...
| Give existing resistance a conflicting objective under the full supernatural chapter burden | Registered four fresh drafts; all 42 units, required narration and rescue choreography stay fixed. One local intention differs. No outputs yet. | `REGISTERED` | [registration](research/quality-measurement/prose-conflicting-objectives/PREREG.md) |
