...
| Add a required ending and then the detailed event sequence to a shared premise and world | Six fresh drafts registered. The premise arm may choose events and stopping point; later layers add narrative obligations without rewriting common facts. No outputs yet. | `REGISTERED` | [registration](research/quality-measurement/prose-constraint-levels/PREREG.md) |
