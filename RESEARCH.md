...
| Actual source withholding, intermediary source selection, conflicting intentions, language mediation and contemporaneous subscription writers | Four connected diagnostics registered, with shared controls and up to 23 sequential calls. No outcomes yet. | `REGISTERED` | [registration](research/quality-measurement/prose-editor-boundary/PREREG.md) |
